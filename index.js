...
/////////////////
const BotName = 'SIMZ BOT☄'; 
const instagram = 'https://instagram.com/ghtrdtr?igshid=xvd2pvihyaft'; 
const telegram = 'https://t.me/smzsaha'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'ngga ada yt';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ghtrdtr')
